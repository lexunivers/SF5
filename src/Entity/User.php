...
class User extends BaseUser
{
    ...
    #[ORM\OneToOne(targetEntity: ComptePilote::class, mappedBy: 'pilote')]
    ...
    {       
        ...
        $this->reservataire = new ArrayCollection();
     ...
     */
    public function getReservataire(): Collection
    {
        return $this->reservataire;
    }

    public function addReservataire(Reservation $reservataire): self
    {
        if (!$this->reservataire->contains($reservataire)) {
            $this->reservataire[] = $reservataire;
            $reservataire->setUser($this);
        }

        return $this;
    }

    public function removeReservataire(Reservation $reservataire): self
    {
        if ($this->reservataire->removeElement($reservataire)) {
            // set the owning side to null (unless already changed)
            if ($reservataire->getUser() === $this) {
                $reservataire->setUser(null);
            }
        }
